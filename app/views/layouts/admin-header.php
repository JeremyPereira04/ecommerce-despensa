...
<head>
    ...
    <link rel="stylesheet" href="<?= e(versioned_asset('assets/css/admin.css')) ?>">
    <link rel="stylesheet" href="<?= e(versioned_asset('assets/css/admin-auth-ui.css')) ?>">
    <link rel="stylesheet" href="<?= e(versioned_asset('assets/css/admin-theme.css')) ?>">
</head>
