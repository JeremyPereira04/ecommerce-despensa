<?php $currentPage = (string) ($_GET['page'] ?? 'home'); $customer = customer_user(); ?>
    ...
    <nav class="navbar navbar-expand-lg" aria-label="Navegación principal">
        <div class="container py-2 header-main">
            ...
            <div class="d-flex align-items-center gap-2 order-lg-3">
                <a class="header-action header-action--account d-none d-sm-flex" href="<?= e(url($customer ? 'orders' : 'login')) ?>">
                    <svg aria-hidden="true" viewBox="0 0 24 24"><path d="M12 12a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9Zm8 9a8 8 0 0 0-16 0"/></svg>
                    <span><?=e($customer ? $customer['name'] : 'Ingresar')?></span>
                </a>
